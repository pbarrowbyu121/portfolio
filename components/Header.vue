  ...
  <div>
    ...
    <div id="header" class="flex justify-between bg-blue-200">
      <div class="flex justify-between">
        <img class="h-16 m-1 rounded-full lg:m-4 lg:h-36" src="~/assets/images/profile_square.png" />
        <NuxtLink to="/" class="m-auto text-lg font-bold text-gray-900 lg:text-4xl">
